 ...
 * @time 2019/3/5 17:28
 */
public abstract class BaseAdapterPageRequestFragment<T,R extends BasePresenter> extends BaseFragment<R> {
    ...
    private BaseAdapter adapterForListView;
    ...
    public void provideListView(ListView listView, BaseAdapter commonAdapter) {
